...
export const PART2_STAFF=[
 {id:'s6',name:'Sofia Mendonça',role:'scout',portrait:null,skill:78,salary:15000,personality:'Observadora',attributes:{precision:82,communication:73,pressure:70,innovation:76}},
 {id:'s7',name:'Laila Okafor',role:'physio',portrait:null,skill:81,salary:17000,personality:'Protetora',attributes:{precision:79,communication:84,pressure:77,innovation:68}},
 {id:'s8',name:'Matteo Rinaldi',role:'strategist',portrait:null,skill:83,salary:21000,personality:'Calculista',attributes:{precision:86,communication:76,pressure:88,innovation:80}},
 {id:'s9',name:'Jun Park',role:'logistics',portrait:null,skill:75,salary:14000,personality:'Metódico',attributes:{precision:84,communication:68,pressure:73,innovation:70}},
 {id:'s10',name:'Amélie Laurent',role:'media',portrait:null,skill:79,salary:16000,personality:'Carismática',attributes:{precision:70,communication:90,pressure:77,innovation:82}}
];
export const YOUTH=[
